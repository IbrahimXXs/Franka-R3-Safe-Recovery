...
def analyze(directory):
    ...
    for c in plan['cases']:
        ...
        pairs.append(dict(case_id=c['case_id'],family=c['family'],split=c['split'],
            ...
            neither_intervenes=not runs['v1']['intervention_count'] and not runs['v2']['intervention_count'],**pair))
    ...
    report(directory,totals,config,pairs,failures,validation)
...
def report(directory,totals,config,pairs,failures,audit):
    ...
    lines+=['',f"V2 initiated {v2['normal_interventions']} normal, {v2['urgent_interventions']} urgent and {v2['terminal_interventions']} terminal recoveries. V1 initiated {v1['recoveries']} normal recoveries.",
