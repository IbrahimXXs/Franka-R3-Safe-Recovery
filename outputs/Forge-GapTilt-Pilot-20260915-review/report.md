...
Status: **target_not_met**. 19 / 23 numerically valid trajectory slots filled.
...
Eligible-parent checkpoint labels: 18 safe witnesses, 0 tested-policy failures, 58 unknown. 80 checkpoint records belong to invalid or incomplete parents.
...
[Trajectory labels](trajectories.csv) · [Checkpoint features and labels](checkpoints.csv) · [Policy tests](recovery_probes.csv) · [Protocol and ledger](aggregate_study.json)
...
147 checkpoints lack two measured whole-recovery costs and are absent from the paired scatter; all remain in `comparison.csv`. Green: safe witness; red: both tested policies fail; grey: unknown/ineligible pair. No safe-only filter is applied.
...
- [../Forge-GapTilt-Pilot-20260915/gap_0507](../Forge-GapTilt-Pilot-20260915/gap_0507/report.md): complete
- [../Forge-GapTilt-Pilot-20260915/gap_0400](../Forge-GapTilt-Pilot-20260915/gap_0400/report.md): complete
- [../Forge-GapTilt-Pilot-20260915/gap_0300](../Forge-GapTilt-Pilot-20260915/gap_0300/report.md): complete
- [../Forge-GapTilt-Pilot-20260915/gap_0200](../Forge-GapTilt-Pilot-20260915/gap_0200/report.md): target_not_met
- [../Forge-GapTilt-Pilot-20260915/gap_0100](../Forge-GapTilt-Pilot-20260915/gap_0100/report.md): target_not_met
