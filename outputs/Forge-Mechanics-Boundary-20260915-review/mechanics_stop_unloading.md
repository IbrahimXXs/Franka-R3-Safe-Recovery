...
本次读取时主矩阵有 3 个完成案例；本表只分析其中 2 个倾斜案例。运行中案例不读取。重新运行同一命令即可更新。

```bash
python3 simulation/analyze_mechanics_stop_unloading.py --study-dir '/home/zephyr/Downloads/Franka-R3-Safe-Recovery-main (1)/Franka-R3-Safe-Recovery-main/outputs/Forge-Mechanics-Boundary-20260915' --output-dir '/home/zephyr/Downloads/Franka-R3-Safe-Recovery-main (1)/Franka-R3-Safe-Recovery-main/outputs/Forge-Mechanics-Boundary-20260915-review'
```
