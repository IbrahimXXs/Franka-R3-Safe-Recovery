...
Status: **pilot_complete**. 2 / 2 pilot cases passed the initial numerical screen. Full collection has not started.
...
Eligible-parent checkpoint labels: 0 safe witnesses, 0 tested-policy failures, 0 unknown. 0 checkpoint records belong to invalid or incomplete parents.
