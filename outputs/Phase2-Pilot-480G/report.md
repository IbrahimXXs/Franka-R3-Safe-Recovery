...
Status: **target_not_met**. 2 / 6 numerically valid trajectory slots filled.
...
Eligible-parent checkpoint labels: 2 safe witnesses, 0 tested-policy failures, 0 unknown. 4 checkpoint records belong to invalid or incomplete parents.
